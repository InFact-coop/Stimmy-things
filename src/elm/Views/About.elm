...
about model =
    div [ classes [ bodyFont, "border-box bg-green flex-column white h-fit-content" ], horizontalTransition model ]
        ...
        , div [ class "mh3 mb5" ]
            ...
            , p [ class "i" ] [ text "*South London and Maudsley Child and Adolescent Mental Health Services" ]
            , p [ class "mb2 i" ] [ text "*Children and Young People's Improving Access to Psychological Therapies" ]            
