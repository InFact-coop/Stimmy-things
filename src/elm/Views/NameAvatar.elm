...
nameAvatar model =
    div [ class "border-box flex-column tc h-fit-content", horizontalTransition model ]
        [ div [ class "flex flex-row ma3 mt0 mb0 items-center justify-between h" ]
            [ div [ onClick <| ChangeView CreateAvatar, class "h4 w3 flex items-centre justify-left" ] [ img [ src "./assets/NameAvatar/back_arrow_green.svg" ] [] ]
            ...
            , div [ onClick <| ChangeView Landing, class "h4 w3 flex items-centre justify-right" ]
