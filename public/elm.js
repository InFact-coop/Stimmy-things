...
var _inFact_coop$stimmy_things$Types$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _inFact_coop$stimmy_things$Types$Stim = F7(
	function (a, b, c, d, e, f, g) {
		return {stimId: a, bodyPart: b, stimName: c, instructions: d, videoUrl: e, shared: f, userId: g};
	});
var _inFact_coop$stimmy_things$Types$Log = F7(
	function (a, b, c, d, e, f, g) {
...
var _inFact_coop$stimmy_things$Types$Moodboard = {ctor: 'Moodboard'};
var _inFact_coop$stimmy_things$Types$AddStimSuccessModal = {ctor: 'AddStimSuccessModal'};
var _inFact_coop$stimmy_things$Types$AddStim = {ctor: 'AddStim'};
var _inFact_coop$stimmy_things$Types$StimRecap = {ctor: 'StimRecap'};
var _inFact_coop$stimmy_things$Types$StimTimer = {ctor: 'StimTimer'};
var _inFact_coop$stimmy_things$Types$StimPreparation = {ctor: 'StimPreparation'};
var _inFact_coop$stimmy_things$Types$StimInfo = {ctor: 'StimInfo'};
...
var _inFact_coop$stimmy_things$Types$Avatar3 = {ctor: 'Avatar3'};
var _inFact_coop$stimmy_things$Types$Avatar2 = {ctor: 'Avatar2'};
var _inFact_coop$stimmy_things$Types$Avatar1 = {ctor: 'Avatar1'};
var _inFact_coop$stimmy_things$Types$Skin7 = {ctor: 'Skin7'};
var _inFact_coop$stimmy_things$Types$Skin6 = {ctor: 'Skin6'};
var _inFact_coop$stimmy_things$Types$Skin5 = {ctor: 'Skin5'};
var _inFact_coop$stimmy_things$Types$Skin4 = {ctor: 'Skin4'};
var _inFact_coop$stimmy_things$Types$Skin3 = {ctor: 'Skin3'};
var _inFact_coop$stimmy_things$Types$Skin2 = {ctor: 'Skin2'};
var _inFact_coop$stimmy_things$Types$Skin1 = {ctor: 'Skin1'};
var _inFact_coop$stimmy_things$Types$Face5 = {ctor: 'Face5'};
var _inFact_coop$stimmy_things$Types$Face4 = {ctor: 'Face4'};
var _inFact_coop$stimmy_things$Types$Face3 = {ctor: 'Face3'};
var _inFact_coop$stimmy_things$Types$Face2 = {ctor: 'Face2'};
var _inFact_coop$stimmy_things$Types$Face1 = {ctor: 'Face1'};
var _inFact_coop$stimmy_things$Types$Feet = {ctor: 'Feet'};
var _inFact_coop$stimmy_things$Types$Legs = {ctor: 'Legs'};
var _inFact_coop$stimmy_things$Types$Hands = {ctor: 'Hands'};
var _inFact_coop$stimmy_things$Types$Arms = {ctor: 'Arms'};
var _inFact_coop$stimmy_things$Types$Belly = {ctor: 'Belly'};
var _inFact_coop$stimmy_things$Types$Chest = {ctor: 'Chest'};
var _inFact_coop$stimmy_things$Types$Shoulders = {ctor: 'Shoulders'};
var _inFact_coop$stimmy_things$Types$Face = {ctor: 'Face'};
var _inFact_coop$stimmy_things$Types$Head = {ctor: 'Head'};
var _inFact_coop$stimmy_things$Types$Frustrated = {ctor: 'Frustrated'};
var _inFact_coop$stimmy_things$Types$Relaxed = {ctor: 'Relaxed'};
var _inFact_coop$stimmy_things$Types$Annoyed = {ctor: 'Annoyed'};
var _inFact_coop$stimmy_things$Types$Optimistic = {ctor: 'Optimistic'};
var _inFact_coop$stimmy_things$Types$Bored = {ctor: 'Bored'};
var _inFact_coop$stimmy_things$Types$Excited = {ctor: 'Excited'};
var _inFact_coop$stimmy_things$Types$Angry = {ctor: 'Angry'};
var _inFact_coop$stimmy_things$Types$Cheerful = {ctor: 'Cheerful'};
var _inFact_coop$stimmy_things$Types$Anxious = {ctor: 'Anxious'};
...
var _inFact_coop$stimmy_things$Types$ChangeView = function (a) {
...
var _inFact_coop$stimmy_things$Components_Button$rectButton = F2(
	function (buttonText, msg) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('flex items-center justify-center bg-green br2 w-100 white pa2 ma2'),
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_1: {
							...
							_0: {
								...
								_1: A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(sizePercent),
									'%')
							},
							_1: {ctor: '[]'}
						}
...
var _inFact_coop$stimmy_things$Data_Feelings$stringToFeeling = function (string) {
	...
	switch (_p0) {
		case 'Happy':
			return _inFact_coop$stimmy_things$Types$Happy;
		case 'Hyper':
			return _inFact_coop$stimmy_things$Types$Hyper;
		case 'Motivated':
			return _inFact_coop$stimmy_things$Types$Motivated;
		case 'Anxious':
			return _inFact_coop$stimmy_things$Types$Anxious;
		case 'Cheerful':
			return _inFact_coop$stimmy_things$Types$Cheerful;
		case 'Angry':
			return _inFact_coop$stimmy_things$Types$Angry;
		case 'Excited':
			return _inFact_coop$stimmy_things$Types$Excited;
		case 'Bored':
			return _inFact_coop$stimmy_things$Types$Bored;
		case 'Optimistic':
			return _inFact_coop$stimmy_things$Types$Optimistic;
		case 'Annoyed':
			return _inFact_coop$stimmy_things$Types$Annoyed;
		case 'Relaxed':
			return _inFact_coop$stimmy_things$Types$Relaxed;
		case 'Frustrated':
			return _inFact_coop$stimmy_things$Types$Frustrated;
		default:
			return _inFact_coop$stimmy_things$Types$Happy;
	}
};
var _inFact_coop$stimmy_things$Data_Feelings$feelings = {
	ctor: '::',
	_0: _inFact_coop$stimmy_things$Types$Happy,
	_1: {
		ctor: '::',
		_0: _inFact_coop$stimmy_things$Types$Hyper,
		_1: {
			ctor: '::',
			_0: _inFact_coop$stimmy_things$Types$Motivated,
			_1: {
				ctor: '::',
				_0: _inFact_coop$stimmy_things$Types$Anxious,
				_1: {
					ctor: '::',
					_0: _inFact_coop$stimmy_things$Types$Cheerful,
					_1: {
						ctor: '::',
						_0: _inFact_coop$stimmy_things$Types$Angry,
						_1: {
							ctor: '::',
							_0: _inFact_coop$stimmy_things$Types$Excited,
							_1: {
								ctor: '::',
								_0: _inFact_coop$stimmy_things$Types$Bored,
								_1: {
									ctor: '::',
									_0: _inFact_coop$stimmy_things$Types$Optimistic,
									_1: {
										ctor: '::',
										_0: _inFact_coop$stimmy_things$Types$Annoyed,
										_1: {
											ctor: '::',
											_0: _inFact_coop$stimmy_things$Types$Relaxed,
											_1: {
												ctor: '::',
												_0: _inFact_coop$stimmy_things$Types$Frustrated,
												_1: {ctor: '[]'}
											}
										}
									}
...
var _inFact_coop$stimmy_things$Views_AddStim$addStim = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('Add Stim'),
			_1: {ctor: '[]'}
		});
};

var _inFact_coop$stimmy_things$Views_AddStimSuccessModal$addStimSuccessModal = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _inFact_coop$stimmy_things$Views_Blog$blog = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _inFact_coop$stimmy_things$Views_CreateAvatar$avatarCaroCell = function (imgSrc) {
	return A2(
		_elm_lang$html$Html$img,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('carousel-cell-image'),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-flickity-lazyload', imgSrc),
				_1: {ctor: '[]'}
			}
		},
		{ctor: '[]'});
};
var _inFact_coop$stimmy_things$Views_CreateAvatar$createAvatar = function (model) {
	return A2(
		_elm_lang$html$Html$section,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('smooth'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('flex justify-center flex-column items-center'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('f3 green avenir center ma0'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('My Stimmy friend'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('ma0 avenir fw2 f4'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Choose your avatar'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('db makecarousel mv2'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _inFact_coop$stimmy_things$Views_CreateAvatar$avatarCaroCell('./assets/avatar.svg'),
						_1: {
							ctor: '::',
							_0: _inFact_coop$stimmy_things$Views_CreateAvatar$avatarCaroCell('./assets/avatar.svg'),
							_1: {
...
var _inFact_coop$stimmy_things$Views_Moodboard$moodboard = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _inFact_coop$stimmy_things$Views_NameAvatar$nameAvatar = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _inFact_coop$stimmy_things$Views_ShareModal$shareModal = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _inFact_coop$stimmy_things$Views_StimInfo$stimInfo = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _inFact_coop$stimmy_things$Views_StimPreparation$stimPreparation = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('border-box bg-green w-100 h-100 flex-column justify-center align-center content-center items-stretch tc'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('w-90 bg-white center h-100 flex-column content-around'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('STIM TITLE'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
...
var _inFact_coop$stimmy_things$Data_View$getViewFromRoute = function (hash) {
	...
	switch (_p0) {
		...
		case '#name-avatar':
			return _inFact_coop$stimmy_things$Types$NameAvatar;
		case '#landing':
			return _inFact_coop$stimmy_things$Types$Landing;
		case '#stim-info':
			return _inFact_coop$stimmy_things$Types$StimInfo;
		case '#stim-preparation':
			return _inFact_coop$stimmy_things$Types$StimPreparation;
		case '#stim-timer':
			return _inFact_coop$stimmy_things$Types$StimTimer;
		case '#stim-recap':
			return _inFact_coop$stimmy_things$Types$StimRecap;
		case '#add-stim':
			return _inFact_coop$stimmy_things$Types$AddStim;
		case '#add-stim-success-modal':
			return _inFact_coop$stimmy_things$Types$AddStimSuccessModal;
		case '#moodboard':
			return _inFact_coop$stimmy_things$Types$Moodboard;
		case '#about':
			return _inFact_coop$stimmy_things$Types$About;
		case '#share-modal':
			return _inFact_coop$stimmy_things$Types$ShareModal;
		case '#blog':
			return _inFact_coop$stimmy_things$Types$Blog;
		default:
			return _inFact_coop$stimmy_things$Types$Landing;
	}
};
var _inFact_coop$stimmy_things$Data_View$viewFromUrl = F2(
	function (location, model) {
		var view = _inFact_coop$stimmy_things$Data_View$getViewFromRoute(location.hash);
		return _elm_lang$core$Native_Utils.update(
			model,
			{view: view});
	});
var _inFact_coop$stimmy_things$Data_View$getCurrentView = function (model) {
	...
	switch (_p1.ctor) {
		...
		case 'NameAvatar':
			return _inFact_coop$stimmy_things$Views_NameAvatar$nameAvatar(model);
		case 'Landing':
			return _inFact_coop$stimmy_things$Views_Landing$landing(model);
		case 'StimInfo':
			return _inFact_coop$stimmy_things$Views_StimInfo$stimInfo(model);
		case 'StimPreparation':
			return _inFact_coop$stimmy_things$Views_StimPreparation$stimPreparation(model);
		case 'StimTimer':
			return _inFact_coop$stimmy_things$Views_StimTimer$stimTimer(model);
		case 'StimRecap':
			return _inFact_coop$stimmy_things$Views_StimRecap$stimRecap(model);
		case 'AddStim':
			return _inFact_coop$stimmy_things$Views_AddStim$addStim(model);
		case 'AddStimSuccessModal':
			return _inFact_coop$stimmy_things$Views_AddStimSuccessModal$addStimSuccessModal(model);
		case 'Moodboard':
			return _inFact_coop$stimmy_things$Views_Moodboard$moodboard(model);
		case 'About':
			return _inFact_coop$stimmy_things$Views_About$about(model);
		case 'ShareModal':
			return _inFact_coop$stimmy_things$Views_ShareModal$shareModal(model);
		default:
			return _inFact_coop$stimmy_things$Views_Blog$blog(model);
	}
};
			...
			case 'UrlChange':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							view: _inFact_coop$stimmy_things$Data_View$getViewFromRoute(_p0._0.hash)
						}),
					{
						ctor: '::',
...
var _inFact_coop$stimmy_things$State$initModel = {
	...
	stims: {ctor: '[]'},
	logs: {ctor: '[]'},
	newStim: _inFact_coop$stimmy_things$Data_Stim$defaultStim,
...
var _inFact_coop$stimmy_things$Main$main = A2(
	_elm_lang$navigation$Navigation$program,
	_inFact_coop$stimmy_things$Types$UrlChange,
	{init: _inFact_coop$stimmy_things$State$init, view: _inFact_coop$stimmy_things$Router$view, update: _inFact_coop$stimmy_things$State$update, subscriptions: _inFact_coop$stimmy_things$Ports$subscriptions})();
