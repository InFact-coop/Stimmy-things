						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {view: a, userId: b, avatar: c, avatarName: d, avatarSkinColour: e, stims: f, logs: g, newStim: h, newLog: i, counter: j, paused: k};
										};
									};
								};
							};
...
var _inFact_coop$stimmy_things$Helpers$isNewListEntry = F2(
	function (string, stringList) {
		return !A2(_elm_lang$core$List$member, string, stringList);
	});
